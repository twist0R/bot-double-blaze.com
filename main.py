...
api = "5782662896:AAHAvG2PFRG58cw4yI6L418jZyrMnASkks2"     #coloca o teu token do bot
chat_id = "-1001853680252"                                  #coloca o id do chat, para o bot colocar no grupo  -100 antes
...
def martingale():
    ...
    if entrada <= max_gale:
        bot.send_message(chat_id, text=f"⚠️atenção a todos {entrada}⚠️")
    else:
        loss()
        reset()
    return
